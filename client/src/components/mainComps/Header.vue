			...
			<nav class="d-flex align-items-center flex-column my-d">
				<div class="navigation d-flex align-items-center flex-column">
					<div class="profile d-flex flex-column align-items-center">
						...
						/>
						<div class="bio mb-3">
							Hello! My name is Shokhboz and I'm a skilled
							software engineer. Welcome to my personal web site.
						</div>
						<ul
						...
						>
							...
							<li class="list-inline facebook">
								<a href="
								https://www.facebook.com/shokhboz.abdullayev.7/
								">
									<i class="fab fa-facebook-f" />
								</a>
							</li>
							<li class="list-inline">
								<a href="https://www.instagram.com/just__a__developer/">
					...
					>
						<h4 class="min entry">Select Preferred Language.</h4>
						<div class="btn-group">
							<button
