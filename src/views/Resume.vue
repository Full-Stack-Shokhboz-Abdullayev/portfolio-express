			...
			>
				<div class="resume-header">
					<div class="row align-items-center">
						<div
							class="resume-title col-12 col-md-6 col-lg-8 col-xl-9"
						>
						...
						<!--//resume-title-->
						<div
							class="resume-contact col-12 col-md-6 col-lg-4 col-xl-3"
						>
							<ul class="list-unstyled mb-0">
								...
								<li class="mb-2">
									...
									>
										...
										/></svg
									><!-- <i class="fas fa-envelope-square fa-fw fa-lg mr-2"></i> Font Awesome fontawesome.com --><a
										target="_blank"
										class="resume-link"
						...
						>
							...
							<!-- <section class="education-section py-3">
										...
										<ul class="list-unstyled resume-awards-list">
											<li class="mb-3">
												...
												<div class="text-mutedl">Microsoft lorem ipsum (2019)</div>
											</li>
											<li>
												<div class="font-weight-bold">Award Donec Sodales</div>
												<div class="text-mutedl">Oracle Aenean (2017)</div>
											</li>
										</ul>
							...
							<section class="skills-section py-3">
								...
								<ul class="list-unstyled resume-lang-list">
									...
									<li class="mb-2">
										Russian
										<span class="text-mutedl">(Fluent)</span>
									</li>
									<li>
										Uzbek
										<span class="text-mutedl">(Native)</span>
									</li>
								</ul>
							</section>
						...
						<li class="list-inline-item mb-lg-0 mr-5">
							<a class="resume-link" href="#">
								<svg
									...
									data-fa-i2svg=""
									style="
										transform-origin: 0.4375em 0.75em;
										font-size: 2rem !important;
									"
								>
									<g transform="translate(224 256)">
										<g
											transform="translate(0, 128)  scale(1, 1)  rotate(0 0 0)"
										>
											<path
												fill="currentColor"
