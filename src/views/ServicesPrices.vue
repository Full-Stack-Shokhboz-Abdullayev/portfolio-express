	...
	<div class="main-wrapper">
		<section class="cta-section theme-bgs py-5">
			<div class="container text-center single-col-max-width">
				...
				<div class="intro">
					<p>
						I have 10+ years of development experience building
						software for the web and mobile devices. You can take a
						look at my
		...
		<section class="pricing-section py-5">
			<div class="container single-col-max-width">
				...
				<div
					id="pricing-tabs"
					class="pricing-tabs d-block d-md-none mb-3"
				>
					<a
						href="#"
						class="pricing-tab active mb-2"
						data-target="pricing-1-data"
						>Basic</a
					>
					<a
						href="#"
						class="pricing-tab mb-2"
						data-target="pricing-2-data"
						>Standard</a
					>
					<a href="#" class="pricing-tab" data-target="pricing-3-data"
						>Premium</a
					>
				</div>
				<!--//pricing-mobile-tabs-->
				...
				<table id="pricing-table" class="pricing-table table-bordered">
					<thead>
						<tr class="border-0">
							<th
								scope="col"
								class="pricing-0-data fafa"
							/>
							<th
								scope="col"
								class="pricing-package-title pricing-1-data fafa"
							>
								Basic
							</th>
							<th
				...
				<div id="faq-accordion" class="faq-accordion mx-auto">
					...
					>
						<div
							...
							@click="openUp($event, index)"
						>
							<h4 class="card-title mb-0">
								<p
									data-parent="#faq-accordion"
									data-toggle="collapse"
									class="card-toggle collapsed m-0"
									aria-expanded="false"
								>
									<svg
