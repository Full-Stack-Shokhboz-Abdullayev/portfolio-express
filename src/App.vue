<template>
	<div>
		<header class="header" :class="{ navOpened }">
			...
			<div>
				<h4 class="pt-lg-4 mb-0 name text-center entry sm-name">
					<b>Shokhboz Abdullayev</b>
				</h4>
				<nav class="d-flex align-items-center flex-column my-d">
					<div
						class="navigation d-flex align-items-center flex-column"
					>
						<div
						...
						>
							...
							/>
							<div class="bio mb-3">
								Hello! My name is Shokhboz and I'm an
								experienced software engineer. Welcome to my
								personal web site.
							</div>
							<ul
						...
						>
							...
							<li class="link" @click="openPages">
								...
								<b class="mr-2">More Pages</b>
								<i class="fas fa-triangle" />
							</li>
						</ul>
						<div
							v-show-slide:300:custom="opened"
							class="more-pages-wrapper mt-2"
						>
							<ul
						...
						<button class="btn btn-block mt-4 custom-btn">
							<i class="fa fa-paper-plane" /> Hire Me
						</button>
						<hr />
						...
						>
							...
							<div class="btn-group">
								<button
									class="selected btn text-light language-btn"
								>
									Eng
								</button>
								<button class="btn text-light language-btn">
									Рус
								</button>
								<button class="btn text-light language-btn">
									Uzb
						...
						>
							<h4 class="min entry">
								<i class="fa fa-adjust" /> {{ text }} Mode
							</h4>
		...
		<footer class="footer text-center py-4">
			<small class="">
				Made by Shokhboz Abdullayev from <a href="">beliefy.io</a> team.
			</small>
			<br />
			<small class="copyright"
				><i class="fa fa-copyright" /> Copyright {{ currentYear }}. All
				rights reserved. <a href="">Privacy Policy</a>.</small
			>
		</footer>
	</div>
</template>
...
<style lang="scss">
hr {
	border-color: var(--pr-tb) !important;
}
